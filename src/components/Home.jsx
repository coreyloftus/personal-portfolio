...
const Home = () => {
    return (
        <div name="home" className="bg-[#32171a] w-full h-screen">
            {/* container */}
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                <p className="text-red-500">Hi there, my name is</p>
                <h1 className="text-4xl sm:text-7xl font-bold text-[#f1e2e2]">Corey Loftus</h1>
                <h2 className="text-4xl sm:text-7xl font-bold text-[#f29e9e]">I'm a Full Stack Developer.</h2>
